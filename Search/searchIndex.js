...
const searchIndex = [
  // Home carousel items
  { id: 'home-uc-mission', name: 'UC Mission', type: 'image', path: 'UC MVH/ucMission.png', page: 'Home' },
  { id: 'home-uc-vision', name: 'UC Vision', type: 'image', path: 'UC MVH/ucVision.png', page: 'Home'},
  { id: 'home-uc-goals', name: 'UC Goals', type: 'image', path: 'UC MVH/ucGoals.png', page: 'Home'},
  { id: 'home-uc-hymn', name: 'UC Hymn', type: 'image', path: 'UC MVH/ucHymn.png', page: 'Home' },
  
  // CCS Department carousel
  { id: 'ccs-mission', name: 'CCS Mission', type: 'image', path: 'CCS MV/ccsMission.png', page: 'CCS Department' },
  { id: 'ccs-vision', name: 'CCS Vision', type: 'image', path: 'CCS MV/ccsVision.png', page: 'CCS Department'},
  { id: 'ccs-goals', name: 'CCS Goals', type: 'image', path: 'CCS MV/ccsGoals.png', page: 'CCS Department' },
  
  // Tech Tutorial pages
{ id: 'tech-tutorial', name: 'Tech Tutorial', type: 'page', path: '../Tech Tutorial/techTut.html', page: 'Tech Tutorial' },
  
  // Navigation pages
  { id: 'nav-guide-go', name: 'Guide GO', type: 'page', path: '../../Guide Go/guideGo.html', page: 'Guide GO' },
  { id: 'nav-home', name: 'Home', type: 'page', path: 'index.html', page: 'Home' },
...
{ id: 'lost-found', name: 'Lost and Found', type: 'page', path: '../Lost and Found/lostnFound.html', page: 'Lost and Found' },
 ...
 // ✅ Guide Go gallery items - Individual titles as image modals (hardcoded for reliability)
  ...
  { id: 'guide-studentaffairs', name: 'STUDENT AFFAIR OFFICE', type: 'page', path: '../Guide Go/guideGo.html', page: 'Guide Go' },
