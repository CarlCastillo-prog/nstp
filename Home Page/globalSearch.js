...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function setupSearch(data) {
    ...
    dropdown.style.cssText = `
      position: fixed;
      background: linear-gradient(135deg, #7f3aa1d0, #5416b5d0);
...
<div style="flex: 1; overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">
  ...
  window.handleSearchItem = function (type, path, name, desc) {
    if (type === 'guide-item') {
  ...
  function createGuideGoModal() {
    ...
    modal.onclick = e =>
      e.target.classList.contains('guide-go-modal') && closeGuideGoModal();
  ...
  function createVideoModal() {
    ...
    modal.onclick = e =>
      e.target.classList.contains('video-modal-overlay') && closeVideoModal();
